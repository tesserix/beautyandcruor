 ...
 * across on desktop, with the counter and progress bar the full galleries want.
 *
 * The scrolling itself now lives in <Rail>, which also carries the desktop
 * arrows; this is the gallery dressing on top of it. Still a client component:
 * the counter is handed to Rail as a render prop, and a function cannot cross
 * a server/client boundary. Frames still arrive as server-rendered children,
 * which is what keeps the manifest off the client.
 *
